...
import { milestone, timelineSect } from "@/util/interfaces";
    ...
    <div>
      ...
      {milestones.map((milestone: milestone) => (
        <div
          ...
          key={milestone.title}
        >
          <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-0 before:h-full before:px-px before:bg-slate-300 sm:before:ml-26 before:self-start before:-translate-x-1/2 before:translate-y-3 after:absolute after:left-2 sm:after:left-0 after:w-2 after:h-2 after:bg-oxfordBlue after:border-4 after:box-content after:border-slate-50 after:rounded-full sm:after:ml-26 after:-translate-x-1/2 after:translate-y-1.5">
            <time
